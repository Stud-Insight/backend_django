...
# backend_django/
APPS_DIR = BASE_DIR / "backend_django"
env = environ.Env()
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "backend_django.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
ADMINS = [("""Lukas Deronzier""", "lukas.deronzier@etu.umontpellier.fr")]
...
ACCOUNT_FORMS = {"signup": "backend_django.users.forms.UserSignupForm"}
...
# Default from email
DEFAULT_FROM_EMAIL = env("DJANGO_DEFAULT_FROM_EMAIL", default="noreply@studinsight.fr")
...
if USE_S3_STORAGE:
    ...
    AWS_S3_ENDPOINT_URL = env("DJANGO_AWS_S3_ENDPOINT_URL", default=None)  # MinIO internal
    AWS_S3_PUBLIC_URL = env("DJANGO_AWS_S3_PUBLIC_URL", default=None)  # MinIO public URL
